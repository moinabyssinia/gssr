...
contains daily maximum surge (m) time series for 882 tide gauges each "csv" file contains a time 
...
20CRV3 (NOAA-CIRES) monolovel variables - 10m Uwnd; 10m Vwnd; mean sea-level pressure (slp)
Spatial resolution  -> 1.0°x1.0°		   		
Temporal resolution -> 3 hourly
https://www.esrl.noaa.gov/psd/data/gridded/data.20thC_ReanV3.monolevel.html
-------------------------------------------------------------------------------------------------
Wget script used to download dataset
-------------------------------------------------------------------------------------------------
wget -A "*.nc" -r ftp://ftp.cdc.noaa.gov/Datasets/20thC_ReanV3/10mMO/

To download files after a specific date (ex. 1900):
-------------------------------------------------------------------------------------------------
Wget –m –nd –A “vwnd.10m.19*.nc” url